...
По умолчанию агенты принимают задачи на русском языке и отвечают на русском языке. Другой язык используется только если пользователь явно попросит об этом.
